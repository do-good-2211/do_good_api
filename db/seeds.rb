...
picard = User.create(name: "Jean-Luc Picard", email: "captain@uss-enterprise.com", password: "IamCaptain!", uid: "55055", provider: "Google Baby!")
riker = User.create(name: "William Riker", email: "number2@uss-enterprise.com", password: "IamNumber2", uid: "22022", provider: "Google Baby!")
data = User.create(name: "Data", email: "data@uss-enterprise.com", password: "IamData?", uid: "33033", provider: "Google Baby!")
geordi = User.create(name: "Geordi La Forge", email: "chief-engineer@uss-enterprise.com", password: "IamEngineer!", uid: "44044", provider: "Google Baby!")
